...
function TampilkanSemuaMenu() {
  $.getJSON("listjualan.json", function (data) {
    //console.log(data);
    let menu = data.menu;
    //console.log(menu);
